									...
									<table class="table">
                                        ...
                                        <?php foreach($etapelist as $etape){ ?>
                                          <tr>
                                            ...
                                            <td><?php echo number_format($etape->longueur, 2, '.', ' '); ?></td>
                                            <td><?php echo $etape->nbre_coureur; ?></td>
                                            <td><a href="<?php echo site_url('CTL_Etape/coureurEtapeList')?>?idetape=<?php echo $etape->id; ?>" class="btn btn-info">Affectation de temps de chaque coureur</a></td>
                                          </tr>
                                        <?php } ?>
                                        </tbody>
                                      </table>
